...
def describe_game(name):
    ...
    """
    # meaning, if we already do not have the user's name,
...
def score(nice,mean,name):
    # Score function is being passed the values scored within the 3 variables
    if nice > 2:    # if condition is valid, call win function passing in the variables so it can use them
        win(nice,mean,name)
    if mean > 2:    # if conditoon is valid, call lose function passing in the variable so it can use them
        lose(nice,mean,name)
...
def win(nice,mean,name):
    # Subtitute the {} wildcards wityh our variable values
...
def lose(nice,mean,name):
    # Subtitute the {} wildcards wityh our variable values
    print("\nAhhhh too bad, game over! \n{}, you live in a in a dirty beat-up \nvan by the river, wretched and alone!".format(name))
    # Call again function and pass in our variable
    again(nice,mean,name)
